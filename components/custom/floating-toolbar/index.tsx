...
const FloatingToolbar = forwardRef<HTMLDivElement, FloatingToolbarProps>(
  ({ editor }, ref) => {
    ...
    return (
      ...
      >
        {/* biome-ignore lint/a11y/useKeyWithClickEvents: onKeyDown is required for toolbar keyboard navigation */}
        {/* biome-ignore lint/nursery/noNoninteractiveElementInteractions: onKeyDown is required for toolbar keyboard navigation */}
        <div

        ...
        hasError: {
            true: {
                root: [
                    ...
                    "hover:has(>:only-child):before:ring-error-base",
                    "has-[input:not(:focus)]:hover:before:ring-error-base",
                    // focus
            ...
            false: {
                root: [
                    // hover - only apply transparent ring when there's only one child and input is not focused
                    "hover:[&:has(>:only-child):not(:has(input:focus))]:before:ring-transparent",
                ],
            },
        },
    },
